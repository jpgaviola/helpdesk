...
namespace HelpdeskBlazor.Services
{
    public interface IUserService
    {
        ...
        Task<User> CreateUserWithPasswordAsync(string name, string email, string role, string department, string plainTextPassword, string domain, string? phone = null, string? location = null, string status = "Active");
    ...
    public class UserService : IUserService
    {
        ...
        public async Task<User> CreateUserWithPasswordAsync(string name, string email, string role, string department, string plainTextPassword, string domain, string? phone = null, string? location = null, string status = "Active")
        {
            ...
            Console.WriteLine($"Created user: {user.Name} with domain: {user.Domain}");
            return user;
        }
